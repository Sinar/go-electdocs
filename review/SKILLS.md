...
NOTE: Use the Bearer Token loaded from the .env file by mise. The env is called NUTRIENT_KEY; do NOT proceed if this is missing! Remind the user to eval into the mise env to enable this.  The key will have prefix of pdf_live_..
