...
func main() {
	// List of N from 71 to 81
	ns := []string{"71", "72", "73", "74", "75", "76", "77", "78", "80", "81"}
	for _, n := range ns {
		transformN(n)
	}
}
...
func getParty(n, candidate string) string {
	...
	case "61":
		switch candidate {
		case "WILSON NYABONG IJANG":
			return "BN"
		case "SOLOMON KUMBONG":
			return "PH (2)"
		case "MOSES RIPAI":
			return "PBDSB"
		case "KRISTOFFER NYUAK BAJOK":
			return "INDEPENDENT 1"
		case "NYAMBONG SIBAT":
			return "INDEPENDENT 2"
		}
	...
	case "64":
		switch candidate {
		case "NICHOLAS KUDI JANTAI MASING":
			return "BN"
		case "KENNETH USANG GEORGE":
			return "PH (2)"
		case "KOH KUMBONG":
			return "INDEPENDENT 1"
		case "SUKARNO LAYAU MAYAU @ ISKANDAR ABDULLAH":
			return "INDEPENDENT 2"
		}
	case "65":
		switch candidate {
	...
	case "66":
		switch candidate {
		case "KENNEDY CHUKPAI UGON":
			return "BN"
		case "ANI AMAT":
			return "PH (1)"
		case "KENNETH ADAN SILEK":
			return "PBDSB"
		case "STANLEY AJANG BATOK":
			return "INDEPENDENT 1"
		}
	case "67":
		switch candidate {
	...
	case "68":
		switch candidate {
		case "JOHNY PANG LEONG MING":
			return "BN"
		case "CHIEW CHAN YEW":
			return "PH (2)"
		case "CHIENG LEA PHING":
			return "INDEPENDENT 1"
		case "NICHOLAS TANG ENG HUI":
			return "INDEPENDENT 2"
		case "ANDY YEK HOCK SIANG":
			return "INDEPENDENT 1"
		case "WONG HAU MING":
			return "INDEPENDENT 2"
		}
	case "69":
		switch candidate {
		case "STEPHEN RUNDI UTOM":
			return "BN"
		case "JOHN BRYAN ANTHONY":
			return "PH (2)"
		case "BERNARD TAHIM BAEL":
			return "INDEPENDENT 1"
		case "CHELEA VANISSA WILLIAM":
			return "INDEPENDENT 2"
		case "JAME STEPHEN RANDI SEKALAI":
			return "INDEPENDENT 1"
		}
	case "70":
		switch candidate {
	...
	case "71":
		...
		case "ROSEY YUNUS":
			return "BN"
		case "NORHAFIZAH MOHAMMAD JOHARIE":
			return "PH (1)"
		case "ABU BAKAR AMIT":
			return "INDEPENDENT 1"
		case "DESMOND GHANI PENGIRAN":
			return "INDEPENDENT 2"
		}
	case "72":
		switch candidate {
		case "RIPIN LAMAT":
			return "BN"
		case "ZOLHAIDAH SUBOH":
			return "PH (1)"
		case "LILA MOHAMAD":
			return "INDEPENDENT 1"
		case "DYANNE OSHIELD NICKSON":
			return "INDEPENDENT 2"
		}
	case "73":
		switch candidate {
		case "SEBASTIAN TING CHIEW YEW":
			return "BN"
		case "PETER HEE LEH KENG":
			return "PH (2)"
		case "HANIM JARAAEE":
			return "INDEPENDENT 1"
		case "STEVE TEO JIA JUN":
			return "INDEPENDENT 2"
		case "DEVORA CHUNG SHIEW YEN":
			return "INDEPENDENT 1"
		}
	case "74":
		switch candidate {
		case "ADAM YII SIEW SANG":
			return "BN"
		case "ALAN LING SIE KIONG":
			return "PH (2)"
		case "ERICK CHIN FEN SIONG":
			return "INDEPENDENT 1"
		case "BRUCE CHAI KHIM CHEONG":
			return "INDEPENDENT 2"
		case "LESLIE TING SIONG NGIAP":
			return "INDEPENDENT 1"
		}
	case "75":
		switch candidate {
		...
		case "BOBBY WILLIAM":
			return "PBDSB"
		case "SUZANNE LEE TZE HA":
			return "INDEPENDENT 1"
		case "ERIC NGIENG SHENG JUN":
			return "INDEPENDENT 2"
		}
	case "76":
		switch candidate {
		case "PENGUANG MANGGIL":
			return "BN"
		case "ELIAS LIPI MAT":
			return "PH (1)"
		case "SAWING KEDIT":
			return "PBDSB"
		case "SYLVESTER ENTRI MURAN":
			return "INDEPENDENT 1"
		case "PIERRE GILBERT YONG":
			return "INDEPENDENT 2"
		}
	case "77":
		switch candidate {
